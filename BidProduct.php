                ...
                <div class="col-md-offset-5 col-md-3">
                    <div class="form-login">
                        ...
                        <a href="Home.php"> <img src="Image/back.jpg" width="50px" height="50px" alt="Bid"/> </a><span
                                style="text-align: center;color: #286090;font-size: 25px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>Enter Information</b></span><br><br><br>
