...
<div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav" style="none">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                                        href="#"><b>&nbsp&nbspProducts</b><span class="caret"></span></a>
    ...
    <div class="container-fluid" style="height:1000px">
        ...
        <h3> If You have any question,comment or if you would like to contact with me please use the form ,
            alternatively you can use one of the links below:</h3>
        <br><br>

        <div class="Parallel">
            &nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/Contacccct.jpg" alt="Photo" width="250px"
                                          height="200px"></img><br>
            <p><a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">Ramzan Hossain</span></a>.
            </p>
        </div>
        ...
        <div class="Parallel">
            ...
            <p><a style="background-color:white;height:25px;width:90%;"> <span style="color:black"><font size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+8801630153125<br></span></a>.<a
                        style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font
                                size="5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+8801713533063</span></a>.
            </p>
        </div>
        ...
        <div class="Parallel">
            ...
            <p><a style="background-color:white;height:30px;width:100%;" href="mailto:firuzahmed70@gmail.com"> <span
                            style="color:black"><font size="5">Firuz Ahmed</span></a></font></span></a>.<a
                        style="background-color:white;height:30px;width:100%;" href="mailto:iamramzanhossain@gmail.com">
                    <span style="color:black"><font size="5"><br>Ramzan</span></a></font></span></p>
        </div>
        ...
        <div class="Parallel">
            ...
            <p><a style="background-color:white;height:30px;width:100%;"
                  href="https://www.facebook.com/00000rmzn1700000"> <span style="color:black"><font
                                size="5">Ramzan</span></font></span></a><a
                        style="background-color:white;height:30px;width:100%;"
                        href="https://www.facebook.com/firuzahmmed170?fref=hovercard"> <span style="color:black"><font
                                size="5"><br>Firuz Ahmed</span></a></p>
        </div>
        ...
        <div class="Parallel">
            ...
            <p><a style="background-color:white;height:30px;width:100%;"
                  href="https://www.linkedin.com/in/ramzan-hossain-25657b12a?trk=nav_responsive_tab_profile_pic"> <span
                            style="color:black"><font size="5">Ramzan</span><a
                            style="background-color:white;height:30px;width:100%;"
                            href="https://www.linkedin.com/in/ramzan-hossain-25657b12a?trk=nav_responsive_tab_profile_pic">
                        <span style="color:black"><font size="5"><br>Firuz</span></a></p>
        </div>

        <div class="Parallel">
            &nbsp&nbsp&nbsp&nbsp&nbsp<img style="align:right" src="Image/firuz.jpg" alt="Photo" width="250px"
                                          height="200px"></img><br>
            <p><a style="background-color:white;height:30px;width:100%;"> <span style="color:black"><font size="5">Firuz Ahmed</span></a>.
            </p>
        </div>
        <br><br>
        ...
        <div>
            <button data-toggle="modal" data-target="#squarespaceModal" class="btn btn-success center-block">Click Here
                To Text Message
            </button>
        </div>
